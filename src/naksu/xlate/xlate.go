...
func SetLanguage(newLanguage string) {
	...
	if currentLanguage == "fi" {
		xlateStrings = map[string]string{
			...
			"Cannot send logs because there is no Internet connection. Logs are in a zip archive in the ktp-jako folder.": "Lokitietoja ei voi lähettää, koska yhteys Internetiin ei toimi. Lokitiedot löytyvät zip-pakettina ktp-jako -kansiosta.",
...
<<<<<<< HEAD
			...
			"Please turn Windows Hypervisor and Windows Virtualization Platform off as those may cause problems.": "Ole hyvä ja kytke Windows Hypervisor ja Windows Virtualization Platform pois päältä, koska ne voivat aiheuttaa ongelmia.",
...
>>>>>>> Remove references to Vagrant, Vagrantfile etc.
	...
	if currentLanguage == "sv" {
		xlateStrings = map[string]string{
			...
			"Cannot send logs because there is no Internet connection. Logs are in a zip archive in the ktp-jako folder.": "Logguppgifterna kan inte skickas, eftersom anslutningen till Internet inte fungerar. Logguppgifterna finns sparade som en zip-fil i ktp-jako-mappen.",
...
<<<<<<< HEAD
			...
			"Please turn Windows Hypervisor and Windows Virtualization Platform off as those may cause problems.": "Vänligen stäng Windows Hypervisor och Windows Virtualization Platform eftersom de kan orsaka problem.",
